...
Begin VB.Form Form13 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Label Label7 
         Alignment       =   2  'Center
         BackStyle       =   0  'Transparent
         Caption         =   "GENERAL STUDENT ACADEMIC PERFORMANCE REPORT FOR SESSION"
         BeginProperty Font 
            Name            =   "Arial Black"
            Size            =   15.75
            Charset         =   0
...
On Error Resume Next
 Label7.Caption = "GENERAL STUDENT ACADEMIC PERFORMANCE REPORT FOR " & Text2.Text & " SESSION"
Dim LItem As ListItem
'Dim matNo(1 To 7), studName(1 To 7), Level(1 To 7), Session(1 To 7), Semester(1 To 7), GPA(1 To 7), Grade(1 To 7)
ListView1.ListItems.clear
 Set myrs = mydb.OpenRecordset("Select * from  PERTAB where (SESSION = '" & Text2.Text & "')")
With myrs
    If .RecordCount <= 0 Then
        MsgBox "No Data Found in the Student Academic Perfomance Table for the specified Session: " & Text2.Text, vbCritical
        Exit Sub
    Else
     I = 1
        Do While Not .EOF
