                        ...
                        <div class="col-xs-12">
                            ...
                            <form class="form-horizontal" role="form" action="?controller=forum&action=update" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input name="forum_name" value="{$forum->forum_name}" type="text" id="form-field-1" placeholder="Forum Name" class="col-xs-10 col-sm-5" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <textarea name="forum_desc" class="col-xs-10 col-sm-5" id="form-field-1" placeholder="Forum Description">{$forum->forum_desc}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
