...
<form id="postform" method="post" action="?action=save_new_topic&forum_id=<?php echo $forum->id ?>" enctype="multipart/form-data">
        ...
        <div class="inner">
            ...
            <fieldset class="fields1">
                ...
                <dl style="clear: left;">
                    ...
                    <dd><input type="text" name="subject" id="subject" size="45" maxlength="124" tabindex="2" class="inputbox autowidth" /></dd>
                </dl>
