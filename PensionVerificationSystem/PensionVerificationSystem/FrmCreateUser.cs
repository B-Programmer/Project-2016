...
namespace PensionVerificationSystem
{
    public partial class FrmCreateUser : Form
    {
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            try
            {
                if ((isAllEntryFilled()) && (!isRegistered(txtUsername.Text)))
                {
                    ...
                    cmd.ExecuteNonQuery();
                    MessageBox.Show("New Authorized User has been successfully Created!!!", "Pension Verification App.", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    cn.Close();
        ...
        private bool isAllEntryFilled()
        {
            ...
            {
                MessageBox.Show("Please set the user type ", "Pension Verification App.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
                cboUserType.Focus();
                return isEntryFilled;
            }
        ...
        private bool isRegistered(string user)
        {
            ...
            try
            {
                ...
                if (dr.HasRows)
                {
                    MessageBox.Show("Fail to create user, username already exists. Duplicate user found ", "Pension Verification App.", MessageBoxButtons.OK, MessageBoxIcon.Exclamation);
